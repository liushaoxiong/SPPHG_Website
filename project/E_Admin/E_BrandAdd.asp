        ...
        <tr>
          <td height="400" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="Img/menu_12.jpg">
            <tr>
              ...
              <td class="Wryh T14 P2"><strong>&nbsp;品牌添加</strong></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
             ...
             <div id="Empty"></div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <form name="editForm" method="post" action="E_ManageSave.asp?SaveType=BrandAdd" onSubmit="return checkdata()">
                 <tr>
                   ...
                   <td><table width="90%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                         ...
                         <td background="Img/Input_03.jpg"><input name="BrandName" class="Titleinput"></td>

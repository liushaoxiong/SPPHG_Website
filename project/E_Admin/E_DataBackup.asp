...
if Instr(session("MagPopdem"),"|10,")=0 then 
        ...
        <tr>
          <td height="400" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="Img/menu_12.jpg">
            <tr>
              ...
              <td class="Wryh T14 P2"><strong>&nbsp;系统备份</strong></td>
              <td width="73"><img src="Img/menu_14.jpg" width="73" height="55"></td>
            </tr>
          </table>
           <div id="Empty"></div>
           <table width="95%" border="0" cellspacing="0" cellpadding="5">
              <form id="form" name="form" method="post" action="E_ManageSave.asp?SaveType=DataBackup">
              <tr>
                ...
                <tr>
                  ...
                  <td align="left"><input type="submit" name="button" id="button" value="备份"  class="tjButton"/></td>
                </tr>
              </form>
              </table>
          </td>

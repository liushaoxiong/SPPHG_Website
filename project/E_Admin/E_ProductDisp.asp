...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="205" valign="top" background="Img/C_bg.jpg"><!--#include file="E_ProMenu.asp"--></td>
    <td width="20"></td>
        ...
        <tr>
          <td height="400" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="Img/menu_12.jpg">
            <tr>
              ...
              <td class="Wryh T14 P2"><strong>&nbsp;查看产品</strong></td>
           ...
           <table width="95%" border="0" cellspacing="0" cellpadding="0">
             <tr>
               <td height="40" class="T16 Wryh Dot"><%=Rs("ProName")%></td>
             </tr>
             <tr>
               <td height="40" class="Dot">所属分类：<%=FunBClassName(Rs("BClass"))%><%If Rs("SClass")<> 0 Then%>&nbsp;-&nbsp;<%=FunSClassName(Rs("SClass"))%><%End If%>　|　发布时间：<%=Rs("Addtime")%>　|　查看次数：<%=Rs("ClickNum")%>　|　<a href="E_ProductEdit.asp?ID=<%=Rs("ID")%>">修改</a>　|　<a href="#" class="Dot" onClick="ifmsgbox('将本条内容彻底删除吗？\n\n删除不可恢复，其相关的文件也将一并删除！','E_ManageSave.asp?SaveType=ProDel&Id=<%=Rs("Id")%>&CurPage=1');">删除</a></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
             </tr>

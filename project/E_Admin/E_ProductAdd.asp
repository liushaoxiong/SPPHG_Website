...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="400" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="Img/menu_12.jpg">
            <tr>
              ...
              <td class="Wryh T14 P2"><strong>&nbsp;产品添加</strong></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
             ...
             <div id="Empty"></div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <form name="editForm" method="post" action="E_ManageSave.asp?SaveType=ProAdd" onSubmit="return checkdata()">
              <tr>
                ...
                <td><table width="90%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td background="Img/Input_03.jpg"><input name="ProName" class="Titleinput"></td>
  ...
  <tr>
    ...
    <td class="Wryh T14">所属品牌：<%call FunListBox("Select * from E_Brand  order by Id Asc","Brand","BrandName","Id",0,"请选择品牌","input")%></td>
  </tr>
</table>
</td>
              </tr>
  ...
  <tr>
    <td width="80"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="8"><img src="Img/Input_01.jpg" width="8" height="33"></td>
                    <td background="Img/Input_03.jpg"><input name="Price1" class="Titleinput"></td>
                    <td width="8"><img src="Img/Input_05.jpg" width="8" height="33"></td>
                  </tr>
                </table></td>
    ...
    <td class="Wryh T14" width="80"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="8"><img src="Img/Input_01.jpg" width="8" height="33"></td>
                    <td background="Img/Input_03.jpg"><input name="Price2" class="Titleinput"></td>
                    <td width="8"><img src="Img/Input_05.jpg" width="8" height="33"></td>
                  </tr>
                </table></td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td><table width="90%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td background="Img/Input1_03.jpg"><textarea name="Title" rows="4" class="Title1input"></textarea></td>

...
<%
totalrec=Conn.Execute("select count(*) from E_About where Id > 0")(0)
sql="Select * from E_About where ID > 0 order by ID desc"
...
do while not rs.eof
ID=rs("ID")
call htmll("","","/About/About-"&ID&".Html","Web/Aboutus.asp","ID=",ID,"ClassID=",ClassID)

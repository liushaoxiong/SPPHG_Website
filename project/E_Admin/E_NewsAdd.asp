      ...
      <table width="95%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FAFAFA">
        <tr>
          <td height="400" align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="Img/menu_12.jpg">
           ...
           <div id="Empty"></div> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <form name="editForm" method="post" action="E_ManageSave.asp?SaveType=NewsAdd" onSubmit="return checkdata()">
              <tr>
                ...
                <td><table width="90%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td background="Img/Input_03.jpg"><input name="Title" class="Titleinput"></td>
              ...
              <tr>
                ...
                <td><table width="90%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td background="Img/Input1_03.jpg"><textarea name="Title1" rows="4" class="Title1input"></textarea></td>
    ...
    <td width="10%">&nbsp;</td>
        ...
        <iframe ID="eWebEditor1" src="../E_eWebEditor/ewebeditor.htm?id=Content&style=Mini" frameborder="0" scrolling="no" width="90%" height="350"></iframe></td>
              ...
              <tr>
                ...
                <td>
                <%If ClassID <> 0 Then%><input name="Classid" value="<%=ClassID%>" type="hidden"><%End If%>

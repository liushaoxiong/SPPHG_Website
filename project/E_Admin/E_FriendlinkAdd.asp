      ...
      <table width="95%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FAFAFA">
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
             ...
             <div id="Empty"></div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <form name="editForm" method="post" action="E_ManageSave.asp?SaveType=LinkAdd" onSubmit="return checkdata()">
                 <tr>
                   ...
                   <td><table width="90%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                         ...
                         <td background="Img/Input_03.jpg"><input name="LinkName" class="Titleinput"></td>
                 ...
                 <tr>
                   ...
                   <td><table width="90%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                         <td width="8"><img src="Img/Input_01.jpg" width="8" height="33"></td>
                         <td background="Img/Input_03.jpg"><input name="LinkUrl" class="Titleinput" value="http://"></td>
                         <td width="8"><img src="Img/Input_05.jpg" width="8" height="33"></td>
                       </tr>
                   </table></td>
                 </tr>
                 <tr>
                   ...
                   <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="110">
						  <label for="WebIfLogo1">
						  <input  name="LinkType" type="radio" onClick="ifLogo0();" value="1" checked>
						  文字</label>
						  <label for="WebIfLogo2">
						  <input type="radio" name="LinkType" id="LinkType1" value="2" onClick="ifLogo1();">图片</label>						  </td>
  <td><div id="divLogo" style="visibility:hidden;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>

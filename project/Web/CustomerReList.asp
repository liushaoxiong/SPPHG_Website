...
<title>患者之声|<%=ClientTitle%>|<%=ClientkeyWords%></title>
...
<table width="1190" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center" valign="top"><table width="96%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="right">您当前的位置：<a href="../">首页</a>&nbsp;>&nbsp;患者之声</td>
      </tr>
    </table>
        <table width="96%" border="0" cellpadding="0" cellspacing="0" background="../E_img/main_04.jpg">
          <tr>
            <td width="105" valign="top" class="ClassName1" align="center">患者之声</td>
...
Sql="select * from E_Message where IfShow = 1 and SaveType = 1 order by ID Desc"
...
%>
          ...
          <tr>
            <td height="30" align="left" bgcolor="f2f2f2" class="Line22" style="padding:8px 0 8px 0"><%=Rs("ReContent")%></td>
          </tr>
          <tr>
            <td height="10">&nbsp;</td>
          </tr>
...
%>
        ...
        <table width="96%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
          <tr bgcolor="">
...
<div class="header" onmousedown=MDown(massage_box)><div style="display:inline; width:150px; position:absolute"><span style="padding-top:8px; font-size:14px"><strong>发布患者之声</strong></span></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<form action="Save.asp?SaveType=CustomerReAdd" method="post" name="formWrite" id="formWrite" onSubmit="return checkdata1()">
  <tr>

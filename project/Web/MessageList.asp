...
<title>意见建议|<%=ClientTitle%>|<%=ClientkeyWords%></title>
...
<table width="1190" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center" valign="top"><table width="96%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="right">您当前的位置：<a href="../">首页</a>&nbsp;>&nbsp;意见建议</td>
      </tr>
    </table>
        <table width="96%" border="0" cellpadding="0" cellspacing="0" background="../E_img/main_04.jpg">
          <tr>
            <td width="105" valign="top" class="ClassName1" align="center">意见建议</td>
...
Sql="select * from E_Message where IfShow = 1 and SaveType = 0 order by ID Desc"

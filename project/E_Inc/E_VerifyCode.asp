...
Private Sub Class_Terminate()
        ...
        Public Property Get Version()
                  Version = "Southidc VerifyCode Class Build V13"
        End Property
...
Sub ShowCode(SessionName)
        Set img = New Southidc_VerifyCode
        Randomize
        Dim code
        ...
        Call img.VerifyCode(code, flase)  ' 处理验证码，第二个参数为是否显示彩色文本
        Call img.Noises(100, flase)   ' 添加杂点，第一个参数为杂点数量，第二个参数为是否显示彩色杂点
        img.ImgWrite ' 输出图片
End Sub
%> 